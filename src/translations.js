export const translations = {
  he: {
    ...
    services: {
      ...
      items: [
        { num: '01', title: 'רקדנית בטן לחינה ואירועים', subtitle: 'מוצר דגל', desc: 'אמילי פלואו — רקדנית בטן שמביאה אנרגיה, צבע ושמחה לחגיגה שלכן. הופעת ריקודי בטן לחינה היא אחד הרגעים הכי קסומים בערב. אני מתמחה בריקוד בטן טרייבל לאירועי חינה: הופעה מלאת אנרגיה ושמחה שמותאמת לאווירה, למוזיקה ולכלה. מחפשות רקדנית בטן לחינה? אני כאן.' },
