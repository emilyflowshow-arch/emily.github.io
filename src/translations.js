export const translations = {
  he: {
    ...
    hero: {
      ...
      name: 'אמילי\nפלואו',
      desc: "רקדנית בטן וטרייבל פיוז'ן עם ניסיון עשיר בהופעות באירועי חינה, חתונה, בר.ת מצווה, חאפלה, מסעדות, פסטיבלים, מועדונים ואירועי קונספט בארץ ובעולם.\n\nהמופעים משלבים נוכחות, תנועה ואינטראקציה עם הקהל — תלבושות מקוריות, כלי אש וג'אגלינג פלואו, מותאמים אישית לכל אירוע.",
      cta: 'הזמיני עכשיו',
      scroll: 'גלי עוד',
    },
    henna: {
    ...
    services: {
      ...
      items: [
        { num: '01', title: 'ריקודי בטן לחינה ולאירועים', subtitle: 'מוצר דגל', desc: 'אמילי פלואו — רקדנית בטן שמביאה אנרגיה, צבע ושמחה לחגיגה שלכן. הופעת ריקודי בטן לחינה היא אחד הרגעים הכי קסומים בערב. אני מתמחה בריקוד בטן טרייבל לאירועי חינה: הופעה מלאת אנרגיה ושמחה שמותאמת לאווירה, למוזיקה ולכלה. מחפשות רקדנית בטן לחינה? אני כאן.' },
        ...
        { num: '04', title: 'אלמנטים מיוחדים', subtitle: 'תלבושות, כלי אש וג\'אגלינג פלואו', desc: 'תלבושות מקוריות המיוצרות בעצמי, כלי אש מרהיבים וג\'אגלינג פלואו ייחודי — אלמנטים ויזואליים שהופכים כל הופעה לחוויה בלתי נשכחת.' },
        { num: '05', title: 'יוגה אשטנגה ויניאסה', subtitle: 'שיעורים וסדנאות', desc: 'יוגה כדרך חיים. החיבור של התנועה והנשימה, המודעות והנוכחות לרגע הזה — כאן ועכשיו.' },
        { num: '06', title: 'סדנאת ״חיבור לעצמי״', subtitle: 'מדיטציה ומיינדפולנס', desc: 'כלים ושיטות להתחבר לכאן ועכשיו. תרגילי נשימה, מדיטציה ו-Emotional Release — בדרך לחיים מודעים יותר.' },
      ],
    },
    gallery: {
      badge: 'רגעים',
  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        { num: '04', title: 'Special Elements', subtitle: 'Costumes, Fire Props & Flow Juggling', desc: 'Original hand-crafted costumes, stunning fire props and unique flow juggling — visual elements that turn every performance into an unforgettable experience.' },
        { num: '05', title: 'Ashtanga & Vinyasa Yoga', subtitle: 'Classes & Workshops', desc: 'Yoga as a way of life. The connection of movement and breath, awareness and presence to this moment — here and now.' },
        { num: '06', title: '"Connect to Yourself" Workshop', subtitle: 'Meditation & Mindfulness', desc: 'Tools and methods to connect to the here and now. Breathing exercises, meditation and Emotional Release — on the path to a more conscious life.' },
      ],
    },
    gallery: {
      badge: 'Moments',
  ...
  ar: {
    ...
    services: {
      ...
      items: [
        ...
        { num: '04', title: 'عناصر خاصة', subtitle: 'أزياء، أدوات نار وجاغلينغ تدفق', desc: 'أزياء أصلية من تصميمي الخاص، أدوات نار رائعة وجاغلينغ تدفق فريد — عناصر بصرية تحوّل كل عرض إلى تجربة لا تُنسى.' },
        { num: '05', title: 'يوغا أشتانغا وفينياسا', subtitle: 'حصص وورش', desc: 'اليوغا كأسلوب حياة. الربط بين الحركة والتنفس، الوعي والحضور في هذه اللحظة — هنا والآن.' },
        { num: '06', title: 'ورشة "التواصل مع الذات"', subtitle: 'تأمل ومايندفولنس', desc: 'أدوات وأساليب للتواصل مع هنا والآن. تمارين تنفس وتأمل وإطلاق عاطفي — في طريق نحو حياة أكثر وعيًا.' },
      ],
    },
    gallery: {
      badge: 'لحظات',
  ...
  ru: {
    ...
    services: {
      ...
      items: [
        ...
        { num: '04', title: 'Особые элементы', subtitle: 'Костюмы, огненный реквизит и Flow жонглирование', desc: 'Оригинальные авторские костюмы, впечатляющий огненный реквизит и уникальное flow жонглирование — визуальные элементы, которые превращают каждое выступление в незабываемый опыт.' },
        { num: '05', title: 'Йога Аштанга и Виньяса', subtitle: 'Уроки и мастер-классы', desc: 'Йога как образ жизни. Связь движения и дыхания, осознанности и присутствия в этом моменте — здесь и сейчас.' },
        { num: '06', title: 'Мастерская "Связь с собой"', subtitle: 'Медитация и майндфулнес', desc: 'Инструменты и методы для связи с настоящим моментом. Дыхательные упражнения, медитация и Emotional Release — на пути к более осознанной жизни.' },
      ],
    },
    gallery: {
      badge: 'Моменты',
