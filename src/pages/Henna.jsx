            ...
            <div className="sticky top-28">
              ...
              <div className="bg-paper-warm border border-ink/10 p-8">
                ...
                <a href="mailto:emilyrich1187@gmail.com"
                  className="block w-full text-center py-4 bg-teal text-paper text-[12px] font-bold tracking-[3px] uppercase hover:bg-teal-dark transition-colors duration-300 mt-3">
                  שלחי מייל
                </a>
              </div>
            </div>
