...
function Nav() {
  ...
  return (
    <>
      <nav className={`fixed inset-x-0 top-0 z-50 flex items-center justify-between px-8 md:px-16 transition-all duration-500
        ${scrolled ? 'py-4 bg-paper/97 backdrop-blur-md border-b border-ink/8 shadow-sm' : 'py-7'}`}>
...
const SOCIALS = [
  {
    href: 'https://www.instagram.com/emily__flow',
    label: 'Instagram',
    handle: '@emily__flow',
  ...
  {
    href: 'https://www.facebook.com/EmilyFlow',
    label: 'Facebook',
    handle: 'Emily Flow',
  ...
  {
    href: 'https://www.youtube.com/@EmilyFlow',
    label: 'YouTube',
    handle: 'Emily Flow',
